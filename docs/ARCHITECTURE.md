...
- **Edge Gateway (Rust/Axum)**: Deployed on Railway. Routes all traffic to Rails API and Python AI service. No GC pauses. Shared reqwest connection pool. Rate limiting planned via tower middleware.
